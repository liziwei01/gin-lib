 ...
 * @LastEditTime: 2023-11-04 04:00:04
 * @Description: 用例
 */
package logit
...
func TestWarning(t *testing.T) {
	...
	SrvLogger.Trace(ctx, "test trace", Error("keyT", fmt.Errorf("valueT")))
	SrvLogger.Notice(ctx, "test notice", Error("keyN", fmt.Errorf("valueN")))
	SrvLogger.Warning(ctx, "test warning", Error("keyW", fmt.Errorf("valueW")))
	SrvLogger.Error(ctx, "test error", Error("keyE", fmt.Errorf("valueE")))
